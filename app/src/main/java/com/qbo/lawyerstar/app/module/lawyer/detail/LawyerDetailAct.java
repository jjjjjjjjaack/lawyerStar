...
public class LawyerDetailAct extends MvpAct<ILawyerDetailView, BaseModel, LawyerDetailPresenter>
    ...
    public static void openAct(Context context, LawyerBean lawyerBean) {
        Intent intent = new Intent(context, LawyerDetailAct.class);
        intent.putExtra("lawyerBean", lawyerBean);
    ...
    public void doBusiness() {
        presenter.lawyerBean = (LawyerBean) getIntent().getSerializableExtra("lawyerBean");
        if (presenter.lawyerBean == null) {
            return;
        }
