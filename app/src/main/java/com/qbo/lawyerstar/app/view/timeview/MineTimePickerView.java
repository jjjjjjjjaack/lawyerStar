...
public class MineTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public MineTimePickerView(PickerOptions pickerOptions) {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.mine_pickerview_time, contentContainer);

            //顶部标题
            TextView tvTitle = (TextView) findViewById(R.id.tvTitle);
            RelativeLayout rv_top_bar = (RelativeLayout) findViewById(R.id.rv_topbar);
            rv_top_bar.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            wheelTime.setSelectChangeCallback(new ISelectTimeCallback() {
                ...
                public void onTimeSelectChanged() {
                    try {
                        ...
                        ((TextView) findViewById(R.id.lasttime_tv)).setText(ToolUtils.date2String(date, "yyyy年MM月dd日HH时mm分"));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
...
//            mPickerOptions.date = mPickerOptions.endDate;
    ...
    private void setTime() {
        ...
        ((TextView) findViewById(R.id.lasttime_tv)).setText(ToolUtils.date2String(new Date(), "yyyy年MM月dd日HH时mm分"));
    }
