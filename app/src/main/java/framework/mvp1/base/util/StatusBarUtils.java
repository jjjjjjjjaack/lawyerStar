...
public class StatusBarUtils {
     ...
     */
    public static void setImmersiveStatusBar(boolean fontIconDark, int statusBarPlaceColor, Activity activity) {
     ...
     */
    private static void setStatusBarFontIconDark(boolean dark, Activity activity) {
        // 小米MIUI
        try {
            Window window =activity.getWindow();
