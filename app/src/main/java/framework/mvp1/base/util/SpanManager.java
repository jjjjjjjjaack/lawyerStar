...
//        }
    ...
    public SpanManager setImageSpan2(Drawable drawable, int start, int end,int leftMargin,int rightMargin) {
        CenterSpaceImageSpan imageSpan = new CenterSpaceImageSpan(drawable,leftMargin,rightMargin);
        drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
        builder.spannable.setSpan(imageSpan, start, end, ImageSpan.ALIGN_BASELINE);
        return this;
    }
